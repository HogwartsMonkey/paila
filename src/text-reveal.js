    ...
    <div className="text-box">
        <div className="nav_menu">
          <ul>
              ...
              <li className={this.props.selectedSection == 3 ? "text-color" : ""} onClick={()=>{this.props.changeVisability(3);window.scrollTo({top:this.props.windowBottom,behavior:'smooth'})}}>What</li>
